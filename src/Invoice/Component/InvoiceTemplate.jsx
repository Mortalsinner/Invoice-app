...
const InvoiceTemplate = () => {
  ...
  return (
    <div id="invoice-print-area" className="max-w-2xl mx-auto bg-white p-8 rounded-xl shadow-lg border border-gray-200">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500">Kode: {sekolah?.Kode_Sekolah}</p>
      </div>
      <div className="mb-6">
      ...
      <div className="text-sm text-gray-500 mt-8">
        ...
        <p><span className="font-semibold">Bank ABC</span> a.n. PT InvoiceApp - 1234567890</p>
      </div>
